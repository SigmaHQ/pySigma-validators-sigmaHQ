# tests/sigmahq/metadata/test_sigmahq_falsepositives_capital_validator.py
...
def test_validator_SigmahqFalsepositivesCapital():
    ...
    assert validator.validate(rule) == [SigmahqFalsepositivesCapitalIssue([rule], word="pentest")]
