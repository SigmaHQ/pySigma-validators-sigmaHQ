...
def test_validator_SigmahqFieldsExistence_valid():
    ...
    assert validator.validate(detection_rule) == [SigmahqFieldsExistenceIssue([detection_rule])]
...
def test_validator_SigmahqFieldsExistence_correlation_valid():
    ...
    assert validator.validate(correlation_rule) == [SigmahqFieldsExistenceIssue([correlation_rule])]
