...
def test_validator_SigmahqInvalidAllModifierIssue_nested():
    """Test that all modifier with single value in nested conditions is detected"""
    validator = SigmahqInvalidAllModifierValidator()
    detection_rule = SigmaRule.from_yaml(
        """
title: Nested All modificator
status: test
logsource:
    category: process_creation
    product: windows
